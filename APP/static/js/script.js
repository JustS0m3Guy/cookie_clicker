...
function bakecookie() {
    ...
    document.querySelector("#cookie_number_div").innerHTML = "cookies: " + cookie_number;
}
...
const save = () => {
    ...
    const params = ["newcookienumber", "grandmanumber", "factorynumber", "cpsu1", "cpsu2", "cpsu3", "cpsu4", "experiencenumber", "levelnumber"];
    const payload = {};
